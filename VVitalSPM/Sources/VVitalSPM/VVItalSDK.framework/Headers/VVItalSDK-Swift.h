...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VVItalSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9VVItalSDK13VVitalManager")
@interface VVitalManager : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate>
...
/// This method is invoked to discovers available service(s) on the peripheral.
/// \param peripheral The peripheral that you tried to connect.
///
/// \param error The error infomation about discoverServices failed.
///
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverServices:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didWriteValueForCharacteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
/// This method is invoked to he peripheral providing this information.
/// object containing the characteristic(s)..
/// \param peripheral The peripheral providing this information..
///
/// \param error The error infomation about didDiscoverCharacteristicsFor failed.
///
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverCharacteristicsForService:(CBService * _Nonnull)service error:(NSError * _Nullable)error;
/// This method is invoked the peripheral that chooses when to send an update,
/// <ul>
///   <li>
///     \code
